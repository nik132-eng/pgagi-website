...
const Footer = () => {
  return (
    <>
      <footer className="relative bg-footerbg pt-8 pb-6  w-full md:text-center  text-white">
        <div className="container mx-auto px-4 hidden sm:block">
          <div className="flex flex-wrap text-left lg:text-left">
            <div className="w-full lg:w-6/12 px-4">
              <div className="flex items-left justify-left pb-4">
                <div className="flex items-center justify-center flex-col">
                  <Image
                    src="/images/pg-agi-75-logo.png"
                    alt="Company logo"
                    width={75}
                    height={75}
                  />
              ...
              <div className="mb-6 flex items-center ">
                <a
                  ...
                  className="mr-3 bg-gray-500 flex h-10 w-10 items-center justify-center rounded-full hover:border hover:bg-primary text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
            ...
            <div className="w-full lg:w-6/12 px-4">
              <div className="flex flex-wrap items-top mb-6">
                <div className="w-full lg:w-4/12 px-4 ml-auto">
                  <span className="block uppercase text-fheaders text-lg font-extrabold mb-2 whitespace-nowrap">
                    Useful Links
                  </span>
                  <ul className="list-unstyled font-sans font-normal">
                    <li>
                      <Link
                        href="/aboutus"
                ...
                <span className="block uppercase text-fheaders text-lg font-extrabold mb-2 whitespace-nowrap">
                  ...
                  <ul className="list-unstyled font-sans hidden md:block font-normal">
                    <li>
          ...
          <div className="flex flex-wrap items-center md:justify-between justify-center">
            <div className="w-full md:w-4/12 px-4 mx-auto text-center">
              <div className="flex justify-center items-center text-fheaders text-base font-semibold py-1 whitespace-nowrap">
                Copyright © <span id="get-current-year">2024</span>
                <a
                  href="https://www.creative-tim.com/product/notus-js"
                  className="flex justify-center items-center text-fheaders hover:text-white"
                  target="_blank"
                  whitespace-nowrap
                >
                  {" "}
        ...
        <div className="container mx-auto px-4 sm:hidden text-center">
          <div className="flex flex-col items-center">
            <div className="mb-4 flex justify-center items-center pb-2">
              <Image
                ...
                height={50}
              />
              <h4 className="text-3xl font-extrabold text-gray-700 whitespace-nowrap">
                PG-AGI
              </h4>
            </div>
            {/* Social icons */}
