...
export default function Book() {
  ...
  return (
    <div className="bg-black min-h-screen flex items-center justify-center px-2 my-20 flex-row ">
      <div className="flex flex-row w-full max-w-5xl p-2">
        <div className="flex items-center justify-center flex-col mb-4 md:mb-0 px-20 rounded-l-3xl  bg-gradient-to-br from-purple_cal">
          <h1 className="text-3xl mb-9 font-bold text-white">
            {" "}
